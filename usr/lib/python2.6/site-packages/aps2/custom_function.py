...
class CustomFunction:
    ...
    def __init__(self, hpr):
        self.hpr = hpr   # environ for information about request
        self.main_name = None
        self.pattern = None
        self.json = None
        self.parameters = []
    ...
    def get_valid_custom_functions(self):
        ...
        for oper in self.hpr.schema_json["operations"]:
            path = self.hpr.schema_json["operations"][oper]["path"]
            if path.find('{') != -1:
            ...
            self.json = self.hpr.schema_json["operations"][oper]
