...
class Types:
    ...
    def save_certificate():
        ...
        aps2.uLogging.logger.info("path = " + aps2.InfoParse.InfoParse.get_pem_path_certificate())
        try:
    ...
    def delete_certificate():
        if os.path.isfile(aps2.InfoParse.InfoParse.get_pem_path_certificate()):
            os.remove(aps2.InfoParse.InfoParse.get_pem_path_certificate())
        if os.path.isfile(aps2.InfoParse.InfoParse.get_apsc_pem_path_certificate()):
            os.remove(aps2.InfoParse.InfoParse.get_apsc_pem_path_certificate())
    ...
    def get_appmeta_et_root():
        ...
        if os.path.isfile(os.environ['APP_PATH'] + NAME_FILE_APP_META):
            ...
            tree_appmeta = aps2.InfoParse.InfoParse.get_APS_API().GET(
                uri_appmeta,
                None,
                None,
                aps2.InfoParse.InfoParse.get_PATH_CERTIFICATE(),
                False
            )
