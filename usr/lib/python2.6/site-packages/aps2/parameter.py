...
def get_arguments(function_description, parsed_environ):
    ...
    aps2.printer.print_json("function_description.json = ", function_description.json)
    # aps2.uLogging.debug(function_description.json)
    aps2.uLogging.debug("function_description.json['path'] = " + function_description.json["path"])
