...
class ServiceId:
    ...
    def get_schema_json():
        ...
        if os.path.isfile(dir_schemas + nf_schema):
            ...
            schema = aps2.InfoParse.InfoParse.get_APS_API().GET("/aps/2/types/?id=" + ServiceId.get_json_service_id()["type"], None, None, aps2.Info.Info.get_PATH_INFO())
