...
class ServiceId:
    ...
    def get_resource_with_old_info():
        old_json = ServiceId.get_old_json()
    ...
    @staticmethod
    def get_old_json():
        if ServiceId.__old_json:
            return ServiceId.__old_json
        else:
            ServiceId.__old_json = aps2.InfoParse.InfoParse.get_aps_api().GET(
...
def get_properties():
    schema = ServiceId.get_schema_json()
    properties = []
