...
def save_certificate_if_necessary(parsed_environ, function_description):
    """
    The certificate is stored in the call POST
    It used when a standard call
    """
    if parsed_environ.get("REQUEST_METHOD") == "POST" and function_description.json["path"] == "/":
        ...
        aps2.uLogging.debug("path = " + path_certificate_pem)
        try:
