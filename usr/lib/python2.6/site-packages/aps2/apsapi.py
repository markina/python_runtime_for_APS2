...
class API:
    ...
    def call(self, verb, path, headers=None, data=None, cert=None, rheaders = None, isJson = True):
        ...
        try:
            ...
            logger.info( 'Status: %s'%resp.getcode() )
        except AttributeError:
            # without code check resp.read() can return empty string
            logger.info( 'Status: %s'%resp.code )
    ...
    def GET( self, path, headers=None, data=None, cert=None, isJson = True ):
        return self.call('GET', path, headers, data, cert, None, isJson)
