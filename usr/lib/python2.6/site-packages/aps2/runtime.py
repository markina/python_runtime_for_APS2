...
def application(environ, start_response):
    ...
    function_description = aps2.utils.get_function_description(parsed_environ, current_service)
    application_object = load_application_object(function_description, )
