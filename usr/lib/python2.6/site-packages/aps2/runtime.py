...
def get_schema(service_id):
    ...
    if os.path.isfile(dir_schemas + nf_schema):
        ...
        schema = APS_API.GET("/aps/2/types/?id=" + service_id.type, None, None, PATH_CERTIFICATE)
...
def call_method_post(environ):
    ...
    # logger.info("service_id.type = " + service_id.type)
    schema = get_schema(get_service_id())
