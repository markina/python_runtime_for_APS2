...
def get_appmeta(json_data):
    if os.path.isfile(os.environ['APP_PATH'] + NF_APP_META):
        ...
        tree_appmeta = aps2.Info.Info.get_APS_API().GET(uri_appmeta, None, None, aps2.Info.Info.get_PATH_CERTIFICATE(), False)
...
def call_method_post():
    ...
    constructor = get_constructor(aps2.Info.Info.get_BODY_JSON())
...
def call_method_delete():
    ...
    old_json = aps2.Info.Info.get_APS_API().GET("/aps/2/resources/" + aps2.InfoParse.InfoParse.get_aps_id(), None, None, aps2.Info.Info.get_PATH_CERTIFICATE())
...
#     # cusstom_function = aps2.custom_function.CustomFunction()
#
...
#     # ###
#
#     old_json = Info.get_APS_API().GET("/aps/2/resources/" + InfoParse.get_aps_id(),
#                                None, None, Info.get_PATH_CERTIFICATE())
#     constructor = get_constructor(old_json)
#
#     properties = get_properties(aps2.ServiceId.ServiceId.get_schema_json())
#     old_resource = constructor()
...
###################################################33
        ...
        logger.info(aps2.Info.Info.get_PATH_INFO())



        logger.info("check : get_application_service_json: ")
        aps2.printer.print_json("", aps2.Types.Types.get_application_services_json())
