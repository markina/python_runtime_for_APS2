...
def application(environ, start_response):
    ...
    try:
        ...
        types = aps2.types2.Types(parsed_environ)  # TODO add save certificate
        service = aps2.service2.Service(types, parsed_environ)
        function_description = aps2.utils.get_function_description(parsed_environ, service)
        application_object = aps2.utils.load_application_object(parsed_environ, types, service, function_description)
        application_object.test_static_func_1("NAME")
